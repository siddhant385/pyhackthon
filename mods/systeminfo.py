...
class systeminfo:
    ...
    def get_system_info(self):
        ...
        info.append("\n" + "="*40 + " Installed Software " + "="*40)
        installed_software = self.get_installed_software()
        info.append(f"Total software installed: {len(installed_software)}")
        info.append("Top 20 installed software:")
        for software in sorted(installed_software)[:20]:
            info.append(f"  {software}")
...
if __name__ == "__main__":
    ...
    print(system_info)  # You can comment this out if you don't want to print

    # Example of how you might use this to send an email
    # (You'd need to set up the email sending functionality)
    # send_email("recipient@example.com", "System Information", system_info)